 ...
 */
import { Class, DomUtil, DragHandler, Eventable, Util, animation, control } from 'maptalks';
...
var Control = function (_maptalks$control$Con) {
  ...
  Control.prototype.onAdd = function onAdd() {
    ...
    var top = DomUtil.computeDomPosition(this._controlDom)[1];
