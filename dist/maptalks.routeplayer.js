...
var Route = function () {
  ...
  Route.prototype.getCoordinates = function getCoordinates(t, map) {
    ...
    var idx = sortedIndexBy_1(this.path, [0, 0, t], function (c) {
      return c[2];
    });
  ...
  Route.prototype.getStart = function getStart() {
    return nth_1(this.path, 0)[2];
  };

  Route.prototype.getEnd = function getEnd() {
    return nth_1(this.path, -1)[2];
  };
  ...
  Route.prototype._setPath = function _setPath(path) {
...
var lib_1 = lib.asString;

var _maptalks$DomUtil = maptalks$1.DomUtil;
var createEl = _maptalks$DomUtil.createEl;
var setClass = _maptalks$DomUtil.setClass;
var on = _maptalks$DomUtil.on;
var off = _maptalks$DomUtil.off;
var preventDefault = _maptalks$DomUtil.preventDefault;
var getEventContainerPoint = _maptalks$DomUtil.getEventContainerPoint;
...
var Control = function (_maptalks$control$Con) {
  inherits(Control, _maptalks$control$Con);

  function Control() {
    classCallCheck(this, Control);
    return possibleConstructorReturn(this, _maptalks$control$Con.apply(this, arguments));
  }

  Control.prototype.buildOn = function buildOn(map) {
    var dom = createEl('div', 'tc-player');
    var content = '<div class="player-btn"></div>\n      <div class="time-info">00:00</div>\n      <div class="time-slider">\n        <div class="ruler">\n          <div class="palyed"></div>\n          <div class="slider-dot"></div>\n        </div>\n      </div>\n      <div class="speed">\n        <div class="speed-info">1.0x</div>\n        <div class="speed-slider">\n          <div class="ruler">\n            <div class="slider-dot"></div>\n          </div>\n        </div>\n      </div>';
  ...
  Control.prototype.onAdd = function onAdd() {
    this._bindEvents();

    var top = maptalks$1.DomUtil.computeDomPosition(this._controlDom)[1];
    this.speedCtlTop = top > 120;
    this._initSpeedDotPos();
    setClass(this._domRefs.speedSlider, 'speed-slider ' + (this.speedCtlTop ? '' : 'bottom'));
  };

  Control.prototype.onRemove = function onRemove() {
    this._offEvents();
  };
  ...
  Control.prototype._bindEvents = function _bindEvents() {
    ...
    this.progressDragger = new maptalks$1.DragHandler(refs.progressCtlDot, { 'ignoreMouseleave': true });
    this.progressDragger.on('dragging', this._onprogressDotDrag, this).enable();

    this.speedDragger = new maptalks$1.DragHandler(refs.speedCtlDot, { 'ignoreMouseleave': true });
  ...
  Control.prototype._onProgress = function _onProgress(time) {
  ...
  Control.prototype._onPlayFinish = function _onPlayFinish() {
    // this.playBtl.innerText = '>'
    this.playing = false;
  };

  Control.prototype._onPlayBtnClick = function _onPlayBtnClick(e) {
    preventDefault(e);
    this.playing = !this._playing;

    if (this.options.player) {
      var player = this.options.player;
      var playState = player.player.playState;
  ...
  Control.prototype._initSpeedDotPos = function _initSpeedDotPos() {
    var p = (1 - this.options.speedRange[0]) / (this.options.speedRange[1] - this.options.speedRange[0]).toFixed(1);
    p = this.speedCtlTop ? 1 - p : p;
    p = 100 * p;
    this._domRefs.speedCtlDot.style.top = p + '%';
  };

  Control.prototype._initDomRefs = function _initDomRefs(dom) {
    var playBtn = dom.querySelector('.player-btn');
    ...
    var speedSlider = speed.querySelector('.speed-slider');
    var speedRuler = speed.querySelector('.ruler');
    var speedCtlDot = speedRuler.querySelector('.slider-dot');
  ...
  Control.prototype._updatePosition = function _updatePosition() {
    ...
    for (var p in position) {
      if (position.hasOwnProperty(p)) {
        if (maptalks$1.Util.isNumber(position[p])) {
    ...
    this.fire('positionchange', {
      'position': maptalks$1.Util.extend({}, position)
    });
  };

  createClass(Control, [{
    key: 'playing',
    set: function set$$1(playing) {
  ...
  return Control;
}(maptalks$1.control.Control);

Control.mergeOptions(options$1);
...
var BaseRoutePlayer = function (_maptalks$Eventable) {
  inherits(BaseRoutePlayer, _maptalks$Eventable);

  function BaseRoutePlayer(routes, map, opts) {
    classCallCheck(this, BaseRoutePlayer);

    var _this = possibleConstructorReturn(this, _maptalks$Eventable.call(this, opts));

    if (!Array.isArray(routes)) {
      routes = [routes];
    }
    _this.id = maptalks$1.Util.UID();
    ...
    if (_this.createLayers) {
      _this.createLayers();
    }
    return _this;
  }

  BaseRoutePlayer.prototype.drawRoutesFrame = function drawRoutesFrame(routes, t) {
    var _this2 = this;

    routes.forEach(function (r) {
      var coo = r.getCoordinates(t, _this2._map);
      console.log('playing', t, coo);
    });
  };

  BaseRoutePlayer.prototype.play = function play() {
  ...
  BaseRoutePlayer.prototype.pause = function pause() {
  ...
  BaseRoutePlayer.prototype.cancel = function cancel() {
    this.player.cancel();
    this.played = 0;
    this._createPlayer();
  ...
  BaseRoutePlayer.prototype.finish = function finish() {
  ...
  BaseRoutePlayer.prototype.getCurrentTime = function getCurrentTime() {
    if (!this.played) {
  ...
  BaseRoutePlayer.prototype.getStartTime = function getStartTime() {
    return this.startTime || 0;
  };

  BaseRoutePlayer.prototype.getEndTime = function getEndTime() {
    return this.endTime || 0;
  };

  BaseRoutePlayer.prototype.setTime = function setTime(t) {
  ...
  BaseRoutePlayer.prototype.getSpeed = function getSpeed() {
    return this._speed;
  };
  ...
  BaseRoutePlayer.prototype._step = function _step(frame, silence) {
    var played = this.duration * frame.styles.t;
    var curt = this.startTime + played;
  ...
  BaseRoutePlayer.prototype._createPlayer = function _createPlayer() {
    var duration = (this.duration - this.played) / (this.options.unitTime * this._speed);
    ...
    this.player = maptalks$1.animation.Animation.animate({
  ...
  BaseRoutePlayer.prototype._resetPlayer = function _resetPlayer() {
  ...
  BaseRoutePlayer.prototype._setup = function _setup(rs) {
    var routes = rs.map(function (r) {
      return new Route(r);
    });
    var start = min_1(routes.map(function (r) {
      return r.getStart();
    }));
    var end = max_1(routes.map(function (r) {
      return r.getEnd();
    }));
  ...
  BaseRoutePlayer.prototype._createControl = function _createControl() {
  ...
  return BaseRoutePlayer;
}(maptalks$1.Eventable(maptalks$1.Class));

BaseRoutePlayer.mergeOptions(options);

var VectorRoutePlayer = function (_BaseRoutePlayer) {
  inherits(VectorRoutePlayer, _BaseRoutePlayer);

  function VectorRoutePlayer() {
    classCallCheck(this, VectorRoutePlayer);
    return possibleConstructorReturn(this, _BaseRoutePlayer.apply(this, arguments));
  }

  VectorRoutePlayer.prototype.drawRoutesFrame = function drawRoutesFrame(routes, t) {
    var _this2 = this;

    routes.forEach(function (r) {
      return _this2.drawRoute(r, t);
    });
  };

  VectorRoutePlayer.prototype.drawRoute = function drawRoute(route, t) {
    if (!this._map) {
      return;
    }
    ...
    var path = route.path.slice(0, coordinates.index);
  ...
  VectorRoutePlayer.prototype.createLayers = function createLayers() {
...
exports.BaseRoutePlayer = BaseRoutePlayer;
exports.VectorRoutePlayer = VectorRoutePlayer;
exports.RoutePlayerControl = Control;
